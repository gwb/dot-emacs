...
#+begin_src emacs-lisp
  ...
  ;;   :mode "\\.k\\'"
  ;;   :config (setq ngnk-cli-file-path "/Users/gwb/Hacks/repos/k/k")
  ;;   :bind (:map ngnk-cli-map ("C-c C-r" . ngnk-send-region)
  ;;                            ("C-c C-c" . ngnk-send-line-at-point))

  ;;   )

  (use-package k-mode
    :mode "\\.k\\'"
    :config (setq k-mode--repl-bin-path "/Users/gwb/Hacks/repos/k/k")
    )
#+end_src
